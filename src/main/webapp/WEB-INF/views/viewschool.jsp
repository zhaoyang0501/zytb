          ...
          <div class="row" style="margin-bottom: 30px">
           <div class="col-lg-12">
              <h2 style="margin-top: 0px;"><strong>北京大学</strong></h2>
              	<div>高校性质： ${school.type }</div>
              	<div>招生电话： ${school.tel }</div>
              	<div>招生邮箱 ： ${school.email }</div>
              		<div>高校地址：${school.addr }</div>
              		<div>高校网址：  <a href="${school.site }">${school.site } </a></div>
              <div class="envor-sorting" id="faq-sorting">
                <div class="envor-sorting-filters">
                  <span data-value="context" class="">高校简介</span>
                  <span data-value="zsjh" class="">招生计划</span>
                  <span data-value="zszc" class="">招生章程</span>
                  <span data-value="dxsl" >大学实力</span>
                  <span data-value="sfbz" class="">收费标准</span>
                </div>
                <div class="envor-toggle">
                	<div class="envor-sorting-item context">
                	 <div class="row" >
                	  	<div class='col-lg-12'>
                	  	<h4><strong>高校简介</strong></h4>
                	  	${school.context }
           		 		</div>
                	 </div>
                	</div>
                 	
                 	<div class="envor-sorting-item zsjh">
                	 <div class="row" >
                	  	<div class='col-lg-12'>
                	  		<h4><strong>招生计划</strong></h4>
                	  	${school.zsjh }
           		 		</div>
                	 </div>
                	</div>
                	...
                	<div class="envor-sorting-item zszc">
                	 <div class="row" >
                	  	<div class='col-lg-12'>
                	  	<h4><strong>招生章程</strong></h4>
                	  	${school.zszc }
           		 		</div>
                	 </div>
                	</div>
                	...
                	<div class="envor-sorting-item dxsl">
                	 <div class="row" >
                	  	<div class='col-lg-12'>
                	  		<h4><strong>大学实力</strong></h4>
                	  	${school.dxsl }
           		 		</div>
                	 </div>
                	</div>
                	
                 	<div class="envor-sorting-item sfbz">
                	 <div class="row" >
                	  	<div class='col-lg-12'>
                	  	<h4><strong>收费标准</strong></h4>
                	  	${school.sfbz }
           		 		</div>
                	 </div>
                	</div>
