...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.historymajor.js"></script>
...
<body>
					...
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<div class="box well form-inline">
								...
								<a onclick="$.adminHistorymajor.initSearchDataTable()"
									class="btn btn-info" data-loading-text="正在加载..."><i class="icon-search"></i>查询</a>
							</div>
							<div class="widget-container">
								
									<a class="btn btn-success" style="float: right; margin: 5px;" onclick="$.adminHistorymajor.showaddModal()"><i class="icon-plus"></i> 新增</a>
								<table class="responsive table table-striped table-bordered"
									id="dt_historymajor_view">
									<thead>
										<tr>
											<th >学校名称</th>
											<th >专业</th>
	...
	<!-- 编辑新增弹出框 -->
	<div class="modal hide fade" id="historymajor_modal">
		<div class="modal-header blue">
			<button type="button" class="close" data-dismiss="modal">×</button>
			<label id="historymajor_modal_header_label"></label>
		</div>
				...
				<div class="span12">
					<div class="form-container grid-form form-background left-align form-horizontal">
						<form action="" method="get" id=''>
							<input type="hidden" id="historymajorId" value="">
		...
		<div class="modal-footer center" id="div_footer">
			<a class="btn btn-primary" onclick="$.adminHistorymajor.save()">保存</a>
